 ...
 */
public class Class_AdapterTest {

    //类的适配器测试
    public static void main(String[] args) {
        Targetable target = new Class_Adapter();
        target.method1();   //继承的方法
        target.method2();   //覆盖的方法
    }
}
